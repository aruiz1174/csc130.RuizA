...
public interface ArrayListADT<T> {
    ...
    /**
     * Set method - return the value at bthe specified location item in this list
     * @param index is th eindex of the item in the list
     * @param info is the reference to the item in the list
     * @return the item if it is in the list, otherwise return null
     */
    public abstract boolean set(int index, T info);
    
    /**
     * set method - change the value at the specified location in the list
     * @param oldInfo is a reference to the item to be modified
     * @param newInfo is a reference to the item to be added
     * @return true if oldInfo is in the list, otherwise return false.
     */
    public abstract boolean set(T oldInfo, T newInfo);
     ...
     * @return
     */
    public abstract boolean add(int index, T info);
}
