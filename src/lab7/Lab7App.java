...
public class Lab7App {
	...
	public static void main(String[] args) {
		...
		OrderedLinkedList<Product> list1 = new OrderedLinkedList<Product>();
		...
		OrderedLinkedList<Product> list2 = new OrderedLinkedList<Product>();
	 ...
	 */
	public static String testSearch(String key, OrderedLinkedList<Product> list)
	{
	 ...
	 */
	public static String testRemove(String key, OrderedLinkedList<Product> list)
	{
